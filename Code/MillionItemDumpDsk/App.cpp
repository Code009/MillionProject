...
cTestRenderTargets::cTestRenderTargets(ID3D12Device *Device)
	: fDevice(Device)
{
}
cTestRenderTargets::~cTestRenderTargets()
{
}

void cTestRenderTargets::Setup(HANDLE RenderBufferHandle,int x,int y)
{
...
cD12RenderTarget cTestRenderTargets::GetRenderTarget(void)
{
...
cTestD3DPainter::cTestD3DPainter()
	: fDevice(gApp.D3DDevice)
	, fSharedRenderTarget(gApp.D3DDevice)
	, fRenderCommand(gApp.D3DDevice)
{
	HRESULT hr;
...
void cTestD3DPainter::RenderBufferChanged(void)
{
	...
	fSharedRenderTarget.Setup(RenderBufferHandle,static_cast<int>(Size.x),static_cast<int>(Size.y));
